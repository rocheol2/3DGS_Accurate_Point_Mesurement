...
export const ERRORS = {
  ...
  E14: {
    level: 'info', title: '좌표 값이 매우 커서 뷰어 내부 원점을 옮겼습니다 (표시 좌표는 원래 값)',
    why: '지역·국가 좌표계(예: X≈285,000 m)로 만든 파일은 GPU 가 쓰는 float32 로는 그 크기에서 약 3 cm 간격밖에 표현하지 못해 렌더링이 깨지거나 열리지 않습니다. 그래서 뷰어가 파일을 읽으면서 모든 좌표에서 일정한 값(오프셋)을 빼 원점 근처로 옮긴 뒤 렌더링합니다.',
