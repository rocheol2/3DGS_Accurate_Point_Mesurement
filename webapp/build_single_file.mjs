...
html = html.replace('<title>3DGS 다시점 거리 측정기</title>', () => '<title>3DGS 다시점 거리 측정기 (단일 파일 · 방향제어)</title>');
...
const OUT = process.argv[2] || 'dist/3DGS_거리측정기_단일파일_방향제어.html'; // 기본: 방향제어 판. 이전 판(…_단일파일.html, …_자동회전.html)은 덮어쓰지 않음
